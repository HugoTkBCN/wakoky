...
{ ?>
    <form class="on_one_line" method="post" action="/?playlistid=<?php echo $playlist_id ?>">
...
{ ?>
    <?php print_button("", "/?playlistid=$playlist_id&linkid=$link_id", "move_up", "15", "10", "moveUp", "assets/up.png"); ?>
    <?php print_button("", "/?playlistid=$playlist_id&linkid=$link_id", "move_down", "15", "10", "moveDown", "assets/down.png"); ?>
    <?php print_button("remove_item", "/?linkid=$link_id", "remove_music", "12", "12", "removeLink", "assets/remove.png"); ?>
    <?php
}
...
function print_musics($playlist_id, $db)
{
    ...
    while ($row_names = mysqli_fetch_assoc($result_link)) {
        ...
        <div class="on_one_line">
            <form method="post" action="/?playlistid=<?php echo $playlist_id ?>&linkid=<?php echo $link_id ?>">
                <div>
            ...
            <a class="music_title" href="/?playlistid=<?php echo $playlist_id ?>&linkid=<?php echo $link_id ?>&play_music=1">
                <?php
                if (strlen($name) > 100) {
